...
namespace UnitTest.Controllers.CourseControllerTest
{
    public class Delete_Course_Tests
    {
        ...
        [Fact]
        public async Task Course_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Course_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Course_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
