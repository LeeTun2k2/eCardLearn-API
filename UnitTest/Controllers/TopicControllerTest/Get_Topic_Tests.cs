...
namespace UnitTest.Controllers.TopicControllerTest
{
    public class Get_Topic_Tests
    {
        ...
        [Fact]
        public async Task Topic_Get_ReturnsOkResult()
        {
            // Arrange
            var filters = new TopicFilterModel();
            var expecteds = new List<TopicViewModel>
            {
                new TopicViewModel(),
                new TopicViewModel()
            };
            ...
            var models = objectResult.Value as IEnumerable<TopicViewModel>;
