...
{
    public class Delete_UserEarnedAchievement_Tests
    {
        ...
        public Delete_UserEarnedAchievement_Tests()
        {
        ...
        [Fact]
        public async Task UserEarnedAchievement_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task UserEarnedAchievement_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task UserEarnedAchievement_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
