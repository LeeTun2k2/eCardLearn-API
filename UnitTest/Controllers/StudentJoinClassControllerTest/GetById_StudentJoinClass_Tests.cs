...
{
    public class GetById_StudentJoinClass_Tests
    {
        ...
        public GetById_StudentJoinClass_Tests()
        {
        ...
        [Fact]
        public async Task StudentJoinClass_GetById_ReturnsOkResult()
        {
            // Arrange
            var id = Guid.NewGuid();
            var expecteds = new StudentJoinClassViewModel{ StudentJoinClassId = id };
            ...
            var model = objectResult.Value as StudentJoinClassViewModel;
        ...
        [Fact]
        public async Task StudentJoinClass_GetById_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task StudentJoinClass_GetById_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
