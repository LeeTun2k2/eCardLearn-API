...
{
    public class Delete_TestAnswer_Tests
    {
        ...
        public Delete_TestAnswer_Tests()
        {
        ...
        [Fact]
        public async Task TestAnswer_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task TestAnswer_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task TestAnswer_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
