...
{
    public class Delete_Achievement_Tests
    {
        ...
        public Delete_Achievement_Tests()
        {
        ...
        [Fact]
        public async Task Achievement_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Achievement_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Achievement_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
