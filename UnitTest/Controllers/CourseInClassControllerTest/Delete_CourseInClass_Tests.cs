...
{
    public class Delete_CourseInClass_Tests
    {
        ...
        public Delete_CourseInClass_Tests()
        {
        ...
        [Fact]
        public async Task CourseInClass_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task CourseInClass_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task CourseInClass_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
