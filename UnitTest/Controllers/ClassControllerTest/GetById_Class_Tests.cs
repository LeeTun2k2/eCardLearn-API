...
{
    public class GetById_Class_Tests
    {
        ...
        [Fact]
        public async Task Class_GetById_ReturnsOkResult()
        {
            // Arrange
            var id = Guid.NewGuid();
            var expecteds = new ClassViewModel{ ClassId = id };
            ...
            var model = objectResult.Value as ClassViewModel;
        ...
        [Fact]
        public async Task Class_GetById_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();

            _mockService.Setup(service => service.GetById(id)).ReturnsAsync((ClassViewModel)null!);
        ...
        [Fact]
        public async Task Class_GetById_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
