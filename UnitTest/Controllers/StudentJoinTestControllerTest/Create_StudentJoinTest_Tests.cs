...
{
    public class Create_StudentJoinTest_Tests
    {
        ...
        public Create_StudentJoinTest_Tests()
        {
        ...
        [Fact]
        public async Task StudentJoinTest_Create_ReturnsCreatedAtActionResult()
        {
            // Arrange
            ...
            _mockService.Setup(service => service.AddAsync(model)).ReturnsAsync(new StudentJoinTestViewModel { StudentJoinTestId = Guid.NewGuid() });
            ...
            var routeValues = Assert.IsType<StudentJoinTestViewModel>(createdAtActionResult.Value);
            Assert.NotNull(routeValues);
        }

        [Fact]
        public async Task StudentJoinTest_Create_ReturnsBadRequestResult()
        {
            // Arrange
            var model = new StudentJoinTestAddModel
            {
            ...
            _mockService.Setup(service => service.AddAsync(model)).ReturnsAsync((StudentJoinTestViewModel)null!);
        ...
        [Fact]
        public async Task StudentJoinTest_Create_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var model = new StudentJoinTestAddModel
            {
