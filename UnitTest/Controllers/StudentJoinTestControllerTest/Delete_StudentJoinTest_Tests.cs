...
{
    public class Delete_StudentJoinTest_Tests
    {
        ...
        public Delete_StudentJoinTest_Tests()
        {
        ...
        [Fact]
        public async Task StudentJoinTest_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task StudentJoinTest_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task StudentJoinTest_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
