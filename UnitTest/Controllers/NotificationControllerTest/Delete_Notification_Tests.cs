...
{
    public class Delete_Notification_Tests
    {
        ...
        public Delete_Notification_Tests()
        {
        ...
        [Fact]
        public async Task Notification_Delete_ReturnsNoContentResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Notification_Delete_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Notification_Delete_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
