...
{
    public class Get_Notification_Tests
    {
        ...
        [Fact]
        public async Task Notification_Get_ReturnsOkResult()
        {
            // Arrange
            var filters = new NotificationFilterModel();
            var expecteds = new List<NotificationViewModel>
            {
            ...
            var models = objectResult.Value as IEnumerable<NotificationViewModel>;
