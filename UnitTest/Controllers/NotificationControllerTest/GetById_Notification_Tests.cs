...
{
    public class GetById_Notification_Tests
    {
        ...
        public GetById_Notification_Tests()
        {
        ...
        [Fact]
        public async Task Notification_GetById_ReturnsOkResult()
        {
            // Arrange
            var id = Guid.NewGuid();
            var expecteds = new NotificationViewModel{ NotificationId = id };
            ...
            var model = objectResult.Value as NotificationViewModel;
        ...
        [Fact]
        public async Task Notification_GetById_ReturnsNotFoundResult()
        {
            // Arrange
            var id = Guid.NewGuid();
        ...
        [Fact]
        public async Task Notification_GetById_ReturnsInternalServerErrorResult()
        {
            // Arrange
            var id = Guid.NewGuid();
