...
namespace UnitTest.Repositories.AchievementRepositoryTest
{
    public class GetAsync_Achievement_Tests
    {
        ...
        {
            // Arrange
            Expression<Func<Achievement, bool>> filter = null!;
            Func<IQueryable<Achievement>, IOrderedQueryable<Achievement>> orderBy = null!;
        ...
        public async Task GetByIdAsync_ShouldReturnEntity()
        {
            ...
            // Assert
            Assert.NotNull(result);
            Assert.Equal("00000000-0000-0000-0000-000000000001", result.AchievementId.ToString());
        }
