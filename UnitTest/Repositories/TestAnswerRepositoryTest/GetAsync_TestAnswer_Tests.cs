...
namespace UnitTest.Repositories.TestAnswerRepositoryTest
{
    public class GetAsync_TestAnswer_Tests
    {
        ...
        {
            // Arrange
            Expression<Func<TestAnswer, bool>> filter = null!;
            Func<IQueryable<TestAnswer>, IOrderedQueryable<TestAnswer>> orderBy = null!;
        ...
        public async Task GetByIdAsync_ShouldReturnEntity()
        {
            ...
            // Assert
            Assert.NotNull(result);
            Assert.Equal("00000000-0000-0000-0000-000000000001", result.TestAnswerId.ToString());
        }
