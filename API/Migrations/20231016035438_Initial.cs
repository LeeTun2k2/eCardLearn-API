        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayRequirement = table.Column<int>(type: "int", nullable: false),
                    UserEarnId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "StudentJoinTest",
                columns: table => new
                {
                    StudentJoinTestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentJoinTest", x => x.StudentJoinTestId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentJoinClassId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClassId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentJoinClass", x => x.StudentJoinClassId);
                    table.ForeignKey(
                        name: "FK_StudentJoinClass_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestAnswer_Answer_AnswerId",
                        column: x => x.AnswerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentJoinClass_StudentId",
                table: "StudentJoinClass",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentJoinTest_StudentId",
                table: "StudentJoinTest",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_TestAnswer_AnswerId",
                table: "TestAnswer",
                column: "AnswerId");
